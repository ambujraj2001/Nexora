...
export const subtractNumbersTool = tool(
  ...
  },
  {
    ...
    description:
      "Subtracts one number from another and returns the result. Use this when asked to subtract, find the difference, or take away one number from another.",
